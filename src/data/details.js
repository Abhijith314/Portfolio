...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Developed mini Campus Management System with role-based access for students, faculty, and administrators using Supabase for secure authentication.",
  ...
  },
  {
    ...
    description:
      "Developed responsive e-commerce frontend with reusable Angular components for product listings and cart management.",
  ...
  },
  {
    ...
    type: "Utility Tool",
    description:
      "Developed full-stack web app enabling browser-based YouTube video and audio downloads with Flask backend.",
...
export const sectionIds = ["home", "about", "skills", "experience", "projects", "contact"];